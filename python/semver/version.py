...
try:
    from ._native import parse_parts as _native_parse_parts
except ImportError:  # universal fallback wheel and source-only execution
...
prerelease='pre.2', build='build.4')
        ...
        if _native_parse_parts is not None and not optional_minor_and_patch:
            try:
                ...
                # Rust semver uses u64 core fields. Falling through preserves
                # Python's arbitrary-size integers and the exact public error.
                pass
